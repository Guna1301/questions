...
class p1{
    ...
    public static void find(int id,int p[], int q[], int n,int swaps){
        if(id>=n){
            if(isAss(p,q)){
        ...
        find(id+1,p,q,n,swaps);
        swap(p,q,id);
        find(id+1,p,q,n,swaps+1);
        swap(p,q,id);
        
    }
    public static void swap(int p[], int q[], int id){
        int temp = p[id];
        p[id] = q[id];
        q[id] = temp;
    }
    public static boolean isAss(int p[], int q[]){
        int n = p.length;
        for(int i=1;i<n;i++){
