...
public class p2{
    public static void main(String[] args){
        ...
        System.out.print(find(root));
        sc.close();
        
    }
    static String find(Node root){
        if(root==null){
            return "";
        }
        ...
        if(root.left==null && root.right!=null){
            sb.append("()");
            sb.append(findd(root.right));
        }else{
            sb.append(findd(root.left));
            sb.append(findd(root.right));
        }
        return sb.toString();
    }
    
    static String findd(Node node){
        if(node==null){
            return "";
        }
        StringBuilder sb = new StringBuilder();
        ...
        sb.append(findd(node.left));
        sb.append(findd(node.right));
        sb.append(")");
        return sb.toString();
    }
